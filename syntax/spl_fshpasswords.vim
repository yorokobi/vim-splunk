...
" Group clusters
syn cluster confStanzas contains=confFshPasswordsStanzas,confGenericStanzas

" fshpasswords.conf
syn match   confFshPasswordsStanzas contained /\v<(credential:\S+:\S+(:.+)?)>/

syn match   confFshPasswords /\v<^(password)>/

"syn match   confFshPasswordsConstants /\v<()$>/
...
hi def link confFshPasswordsStanzas Identifier
hi def link confFshPasswords Keyword
hi def link confFshPasswordsConstants Constant
